...
<div class="contenedorinicioinformación">
    ...
    <div class="container p-4  mt-5 contenedorformularioinicio centrar">
        <div class="row align-items-center">
            ...
            <?php elseif (in_array($id_tipo_usuario, [4, 6, 7, 9, 10, 11, 12])): // Administrador DEMOS, Usuario DEMOS, Administrador Flotilla, Usuario Flotilla, Usuario Flotilla General ?>
            <!-- Imagen -->
            <div class="col-lg-5 text-center imagenlogo">
