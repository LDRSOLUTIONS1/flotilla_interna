...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-03-2025 a las 23:33:11
...
CREATE TABLE `polizas` (
  `id_tipo_polizas` int(11) NOT NULL,
...
--
ALTER TABLE `polizas`
  ADD PRIMARY KEY (`id_tipo_polizas`);
...
--
ALTER TABLE `polizas`
  MODIFY `id_tipo_polizas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=3;
