...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 14-03-2025 a las 23:43:53
...
INSERT INTO `unidades` (`id_unidad`, `id_modelo`, `id_estado_unidad`, `id_estatus_unidad`, `id_tipo_adquisicion`, `id_sede`, `id_poliza_seguro`, `vin`, `kilometraje`, `placa`, `tarjeta_circulacion`, `color`, `img_unidad`) VALUES
(1, 1, 1, 1, 1, 1, 0, 'JTDBE32K123456789', 15000, 'ABC-123', '', 'Rojo', ''),
(2, 2, 2, 2, 1, 6, 0, '1HGCM82633A004352', 20000, 'XYZ-789', '', 'Azul', ''),
(5, 1, 1, 2, 1, 7, 0, 'HJRPBGGB6RB151012', 12345678, 'MSH449A\r\n', '', 'Negro', '');
