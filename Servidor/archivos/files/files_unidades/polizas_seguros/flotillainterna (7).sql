...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-03-2025 a las 18:42:40
...
--
-- Volcado de datos para la tabla `poliza_seguro`
--

INSERT INTO `poliza_seguro` (`id_poliza_seguro`, `poliza_seguro`, `img_poliza_seguro`) VALUES
(1, '45678ulkjhbgv', 'drtfyguhjbj'),
(2, 'fcygyuiuoi', 'dtrytgy8hu9ji0'),
(3, 'cfytgy8hu9ji0o', 'se5ttugijb');
...
--
-- Volcado de datos para la tabla `poliza_tenencia`
--

INSERT INTO `poliza_tenencia` (`id_poliza_tenencia`, `poliza_tenencia`, `img_poliza_tenencia`) VALUES
(1, 'esrdtfyvhbjn', 'swert56yu78ihb'),
(2, 'fctfyguhik', 'rdytug'),
(3, 'rdtf7tguoip', 'esdr67f68t98y0pu9');
...
INSERT INTO `unidades` (`id_unidad`, `id_modelo`, `id_estado_unidad`, `id_estatus_unidad`, `id_tipo_unidad`, `id_tipo_adquisicion`, `id_sede`, `id_poliza_seguro`, `id_poliza_tenencia`, `vin`, `kilometraje`, `placa`, `tarjeta_circulacion`, `color`, `img_unidad`, `fecha_adquisicion`, `detalles_adquisicion`) VALUES
(1, 1, 1, 1, 1, 1, 1, 1, 1, 'JTDBE32K123456789', 15000, 'ABC-123', '', 'Rojo', '', NULL, ''),
(2, 2, 2, 2, 1, 1, 6, 2, 2, '1HGCM82633A004352', 20000, 'XYZ-789', '', 'Azul', '', NULL, ''),
(5, 1, 1, 2, 2, 1, 7, 3, 3, 'HJRPBGGB6RB151012', 12345678, 'MSH449A\r\n', '', 'Negro', '', NULL, '');
...
--
-- AUTO_INCREMENT de la tabla `poliza_seguro`
--
ALTER TABLE `poliza_seguro`
  MODIFY `id_poliza_seguro` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;

--
-- AUTO_INCREMENT de la tabla `poliza_tenencia`
--
ALTER TABLE `poliza_tenencia`
  MODIFY `id_poliza_tenencia` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=4;
...
--
ALTER TABLE `unidades`
  ADD CONSTRAINT `FK_unidades_poliza_seguro` FOREIGN KEY (`id_poliza_seguro`) REFERENCES `poliza_seguro` (`id_poliza_seguro`),
  ADD CONSTRAINT `FK_unidades_poliza_tenencia` FOREIGN KEY (`id_poliza_tenencia`) REFERENCES `poliza_tenencia` (`id_poliza_tenencia`),
