...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 19-03-2025 a las 01:17:55
...
INSERT INTO `poliza_seguro` (`id_poliza_seguro`, `id_unidad`, `poliza_seguro`, `img_poliza_seguro`) VALUES
(1, 1, '45678ulkjhbgv', 'drtfyguhjbj'),
(2, 1, 'fcygyuiuoi', 'dtrytgy8hu9ji0'),
(3, 1, 'cfytgy8hu9ji0o', 'se5ttugijb');
...
INSERT INTO `poliza_tenencia` (`id_poliza_tenencia`, `id_unidad`, `poliza_tenencia`, `img_poliza_tenencia`) VALUES
(1, 1, 'esrdtfyvhbjn', 'swert56yu78ihb'),
(2, 1, 'fctfyguhik', 'rdytug'),
(3, 1, 'rdtf7tguoip', 'esdr67f68t98y0pu9');
...
--
ALTER TABLE `poliza_seguro`
  ADD CONSTRAINT `FK_piliza_seguro_unidades` FOREIGN KEY (`id_unidad`) REFERENCES `unidades` (`id_unidad`);

--
-- Filtros para la tabla `poliza_tenencia`
--
ALTER TABLE `poliza_tenencia`
  ADD CONSTRAINT `FK_poliza_tenencia_unidades` FOREIGN KEY (`id_unidad`) REFERENCES `unidades` (`id_unidad`);
