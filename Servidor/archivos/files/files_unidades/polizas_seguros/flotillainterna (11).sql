...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 20-03-2025 a las 22:17:39
...
INSERT INTO `polizas` (`id_polizas`, `id_tipo_poliza`, `id_unidad`, `identificador_poliza`, `documento_poliza`) VALUES
(3, 2, 1, 'tfyguhi', 'aveoazul.png'),
(4, 2, 1, 'tfyguhi', 'aveoazul.png'),
(5, 1, 5, '4e5r6t7', 'flotillainterna (8).sql'),
(6, 1, 1, 'uhijok', 'unidadazul.png'),
(7, 2, 1, 'hjkhghcv', 'user.png');
...
--
ALTER TABLE `polizas`
  MODIFY `id_polizas` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=8;
