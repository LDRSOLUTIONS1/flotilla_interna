...
if (
    ...
    $color = $objetivo_prestamo = $comentarios = $colaboradorqueasigna = $persona_fisica = '';
    ...
    $query = "SELECT u.id_unidad, 
              ...
              INNER JOIN personas_fisicas AS pf ON asigun.id_persona_fisica = pf.id_persona_fisica
    ...
    if ($fila = $resultado->fetch_assoc()) {
        ...
        $persona_fisica = trim($fila['nombre_1_pf'] . ' ' . $fila['nombre_2_pf'] . ' ' . $fila['ap_pf'] . ' ' . $fila['am_pf']);
